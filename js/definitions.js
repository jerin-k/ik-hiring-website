...
export const DEFINITIONS = {
  ...
  'hm-positions': {
    ...
    confirmed: 'Definitions confirmed with Jerin · 24 Aug 2026 · Joined = someone moved to Hired into the position 14 Sep 2026 · From / To narrows every panel to the day (#129) 15 Sep 2026 \u00b7 Pipeline hides From / To (#141d) 17 Sep 2026 · Specialisation level for SME (#157) 20 Sep 2026 · the level stops at the topic (#157c) 21 Sep 2026 · a role opens only when one of its positions has a topic; Expand all reaches the topics (#160) 22 Sep 2026 · Joining pending and Who is joining at the topic level, untied people on the role row (#161, A) 22 Sep 2026 \u00b7 a remark keeps its line breaks, and who wrote it shows only while editing, as a first name rather than an email (#180) 26 Sep 2026 \u00b7 a Who has joined column beside Who is joining, listing the people who actually started (#182a) 26 Sep 2026',
    groups: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          ['Why some columns show a dash', 'Only <strong>Total openings</strong>, <strong>Joined</strong> and <strong>Missed</strong> split by topic for everyone, because those count positions and a position carries its own topic. <strong>Joining pending</strong> splits for the people Ashby ties to a position before hire \u2014 their <strong>offer names an opening</strong> \u2014 who sit under that opening\u2019s topic; everyone else stays on the role row, so the topics plus the role row add up to its Joining pending. <strong>Dropped</strong> and <strong>Delta</strong> show a dash: a person who dropped can never be tied to a position, so there is no honest per-topic figure, and a dash is shown rather than a number that would look right and be wrong. Those figures are correct on the role row above.'],
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          ['Who is joining', 'The people behind the <strong>Joining Pending</strong> number on the same row, with the date they are due to start and the stage they are at. It is counted the same way, so the names always add up to that number. Like it, the list is <strong>live</strong> — the From and To dates do not change it. Long lists collapse; <em>+N more</em> opens them. On an SME role that opens to topics, each person is listed under the topic of the opening their offer names, and the role row keeps only the people not tied to an opening, each with why: <em>offer not initiated</em> (still in Ref Check or Documentation), <em>offer names no opening</em>, or <em>opening not in this period</em> \u2014 plus a line saying how many sit under their topics.'],
          ['Who has joined', 'The people who <strong>actually started</strong> in this period \u2014 accepted an offer, were moved to <strong>Hired</strong>, and have a start date between the <strong>From</strong> and <strong>To</strong> dates. Same people, same test, as the <strong>Joiners</strong> sub-tab, so the two never disagree. 🚨 <strong>The number of names here can differ from the Joined column</strong>, and that is not a fault: <strong>Joined counts POSITIONS filled</strong> against this quarter\u2019s openings, while this lists <strong>PEOPLE</strong>, and it leaves nobody out \u2014 including anyone filling a position opened in an earlier quarter. One position can also take more than one person over a quarter. If you want the two to agree, the Recruiter Efficiency tab counts people on both sides. On an SME role the topics underneath show a dash here: splitting joiners by topic is not worked out at that level, and a dash says so rather than showing a number that would be short.'],
          ['Remarks', 'A note your team writes against the <strong>role</strong>, not a candidate — it stays until somebody edits it, and everybody sees the same note. Anyone who can open this tab can write one. 🚨 It is saved to a file that <strong>anyone with the link can read</strong>, so it must never hold candidate names, salaries, phone numbers or email addresses; an email address or a long number is refused. Saving opens a small window that signs you in and closes itself; a note normally lands in about five seconds. <strong>Who wrote it, and when, is shown only while you are editing</strong> — one line above Cancel and Save — so the column itself carries the remark and nothing else. It records a <strong>first name</strong>, never an email address: the file is publicly readable, and it would be odd to refuse an email inside the remark while publishing one beside it. It is signed by the Google account this <strong>browser</strong> is signed into, which is not always the account you signed into the dashboard with — if the two differ the dashboard tells you as you save, so a remark never quietly carries the wrong name. <strong>Line breaks are kept</strong>: type two lines and you get two lines. Amber, and the words <em>Unsaved — in this browser only</em> under the remark, mean the note is in your browser only and the server has not confirmed it yet — it clears itself next time you open the page, once the saved copy agrees.'],
        ]
      },
      {
        heading: 'The chart',
  ...
  'hm-joiningpending': {
    ...
    confirmed: 'Definitions confirmed with Jerin · 24 Aug 2026 · on its own sub-tab (#130) 15 Sep 2026 · the opening Ashby shows them tied to (#132) 15 Sep 2026 · DOJ boxes replace the period boxes (#133) 15 Sep 2026 · badges and date labels (#137) 15 Sep 2026 · month ➔ date ➔ people, option A (#149) 19 Sep 2026 \u00b7 the topic each person was really for, with the reason when it cannot be shown (#168) 23 Sep 2026 \u00b7 Opening and Topic as two columns, the opening by its full name (#169) 23 Sep 2026',
    groups: [
      {
        heading: 'The columns',
        items: [
          ['Opening', 'The <strong>position</strong> this person is tied to, by its full name \u2014 <em>IK-403 - Recruiter - Role Type - Topic</em> \u2014 which is what it is called in Ashby. When it cannot be shown the cell says <em>no opening on the offer</em> (nobody has tied the offer to a position yet, so this person cannot be counted against one) or <em>not in this period</em>. While the name is still working its way through the data it shows the position\u2019s short id instead, and turns into the name at the next refresh (Jerin, 23 Sep 2026).'],
          ['Topic', 'On an <strong>SME</strong> role that uses topics, the <strong>Specialization/Topic</strong> of the opening this person\u2019s offer names \u2014 what they were really hired for. When it cannot be shown the cell says <em>why</em>, because each reason is a different job for a different person: <em>no opening on the offer</em> (link the offer to an opening), <em>opening has no topic</em> (set it \u2014 those openings are listed on <strong>Recruiter Efficiency \u2794 Data Hygiene \u2794 Openings Missing a Topic</strong>), or <em>opening not in this period</em>. A role where <strong>no</strong> opening carries a topic shows a plain dash: that role does not use topics, so nothing is missing (Jerin, 23 Sep 2026).'],
          ...
          ['What the date headings say', 'The candidate’s date of joining. The heading turns <strong>rose</strong> once the date has passed and they are still not moved to Hired; hover it for the weekday and how many days ago. <em>Not set</em> when there is no DOJ yet.'],
  ...
  'hm-joiners': {
    ...
    confirmed: 'Added with Jerin · 15 Sep 2026 (#130) · the opening read from the hire (#131) 15 Sep 2026 · badges and date labels (#137) 15 Sep 2026 · month ➔ date ➔ people, option A (#149) 19 Sep 2026 \u00b7 the topic each person was really for, with the reason when it cannot be shown (#168) 23 Sep 2026 \u00b7 Opening and Topic as two columns, the opening by its full name (#169) 23 Sep 2026',
    groups: [
      {
        heading: 'The columns',
        items: [
          ...
          ['What the date headings say', 'The day they started (their date of joining), and its month. Hover a date for its weekday.'],
  ...
  'rec-fulfilment': {
    summary: 'How these numbers are worked out',
    intro: '<strong>Five tables, one per pod</strong> — Sales, SME-US, SME-India, Lateral and Others — all the same shape, each with its own chart. What each one counts is written into its own <strong>Capacity</strong> and <strong>Goal</strong> headings: <strong>Sales</strong>, <strong>SME-US</strong>, <strong>SME-India</strong> and <strong>Others</strong> are measured on <strong>Joiners</strong>, <strong>Lateral</strong> on <strong>Offers</strong>. Filter to one pod, or to one recruiter, and <strong>only their table stays on the page</strong>. Everything follows the Year/Quarter selector at the top, and the <strong>From</strong> and <strong>To</strong> dates inside that quarter narrow it to the day \u2014 only Joining Pending stays live. There is no <em>All</em> on this tab: goals, pods and capacity belong to a quarter, and people move between pods, so quarters are never added together. The <strong>Job</strong> filter narrows every number to the chosen jobs. While it is on, or your access is limited to certain departments, <strong>Capacity</strong> and <strong>Capacity Utilisation</strong> read a dash.',
    confirmed: 'Definitions confirmed with Jerin · 24 Aug 2026 · no Quarter: All on this tab 15 Sep 2026 · Goal basis updated 6 Sep 2026 · Joined split on Sales and Others added 7 Sep 2026 · recruiter/sourcer credit rule replaced and the +N sourced line added 13 Sep 2026 · Goal counts filled openings and leaves out archived ones 14 Sep 2026 · the Job filter narrows every number, and Capacity reads a dash while it does, 14 Sep 2026 · JP \u2014 Prev Qtr Openings takes any earlier quarter 15 Sep 2026 \u00b7 From / To narrows every column to the day and scales Capacity by days (#129) 15 Sep 2026 \u00b7 Specialisation level for SME, Goal split by topic (#157) 20 Sep 2026 \u00b7 the three Joining Pending columns split by topic too, and a topic appears for someone in closing even where the recruiter owns no position in it (#161b, B) 22 Sep 2026 \u00b7 Joined splits by topic as well, with a (not tied to a topic) line so the column still adds up (#166, A) 23 Sep 2026 \u00b7 a topic is listed for a JOINER of theirs too, so the leftovers line holds only offers naming no position (#168) 23 Sep 2026 · a N no score caption under the Joining Pending total Score (#176c) 25 Sep 2026 · the quarter sub-columns removed from Joined and Joining pending on every table, and Sales/Others’ Joined gained its Score (#177) 25 Sep 2026 · five tables one per pod, Delta shows the surplus, Lateral’s Delta also subtracts Drop, one chart per table, and the Capacity/Goal headings say what each table is measured on (#179) 25 Sep 2026',
    groups: [
      {
        ...
        items: [
          ...
          ['Score', 'The same thing weighted by how hard the role is: each role scores points from its Family, Level and the <strong>Complexity set on that opening</strong> (not on the job - two openings on one job can differ), through the grid in <strong>Admin → Scoring</strong>. An opening with <strong>no Complexity scores nothing</strong>: a blank is not an answer. A senior niche hire is worth many times a vanilla one. <strong>Where a candidate has a Sourcer, the points for Joined, Joining Pending and Drop are shared half and half</strong> — see <em>How credit is shared with a Sourcer</em> below. The Goal is never shared.'],
        ]
      },
      {
        heading: 'The columns',
        items: [
          ['Goal', 'The <strong>openings you own</strong> that were opened in the selected quarter, on a day between the <strong>From</strong> and <strong>To</strong> dates \u2014 the positions where you are the <strong>Recruiter on the opening</strong> in Ashby, not every role you have ever touched. Each opening scores from its role’s Family and Level and <strong>its own Complexity</strong>; one with no Complexity scores nothing, and the number of those is named under the Score so they can be put right. <strong>The Goal is never shared</strong>: even where an opening also has a Sourcer, the recruiter keeps its full points. Openings a person is tagged on as <strong>Sourcer</strong> show underneath as <strong>+N sourced</strong>, with no points attached. Openings still open, already filled or carried forward all count; <strong>archived</strong> openings do not. The bracket in the heading — <strong>Goal (Joiners)</strong> or <strong>Goal (Offers)</strong> — says what that table measures the Goal against. It is the same Goal either way; see <em>What the brackets in the headings mean</em> below.'],
          ['Capacity', 'What this recruiter is expected to carry in the quarter, as a <strong>Score</strong>, set by hand in <strong>Admin → Pod &amp; Capacity</strong>. It reads 0 until somebody sets it. When the From and To dates cover only part of the quarter, Capacity is <strong>that share of it by days</strong> \u2014 1 to 31 August is 31 of Q3\u2019s 92 days. It is not the Goal — the Goal comes from the openings the recruiter owns. Role rows show a dash, because capacity is set per recruiter — and every row does while the <strong>Job</strong> filter or a department restriction narrows the numbers, because capacity cannot be split by job or department. On the <strong>Others</strong> table the heading reads <strong>Capacity (NA)</strong>, because agencies are not given a capacity — <strong>only the heading says NA</strong>; the cells below stay exactly as they are, which is a dash.'],
          ['Joined', 'Candidates <strong>moved to the Hired stage</strong>, dated by their <strong>start date</strong>, from the individual offer records — an accepted offer alone is not counted. On <strong>SME-US</strong>, <strong>SME-India</strong> and <strong>Lateral</strong> it also excludes anyone linked — by their offer, or by the opening they were hired into — to an <strong>earlier quarter\u2019s opening</strong> — last quarter\u2019s work landing now. <strong>Sales and Others take no such subtraction</strong>, deliberately: their goal is joiners whenever the opening was raised. Its <strong>Score</strong> now shows on every table — <strong>Sales</strong> and <strong>Others</strong> carried heads only until 25 Sep 2026, because their Score sat in two quarter columns that have since been removed.'],
          ['Joining pending <span class="defs-tag">heads and score</span>', 'Everyone currently in <strong>Reference Check, Documentation or Offer</strong>. On <strong>SME-US</strong>, <strong>SME-India</strong> and <strong>Lateral</strong> it leaves out anyone on an <strong>earlier quarter’s opening</strong>, and anyone joining next quarter on an opening that is not this quarter’s; <strong>Sales</strong> and <strong>Others</strong> take no such subtraction. It is <strong>live</strong> — the From and To dates do not change it. Under the Score, a <strong>N no score</strong> caption counts how many of those same people scored <strong>nothing</strong> — their offer names <strong>no opening</strong>, or the opening it names has <strong>no Complexity</strong>: a count of people already in the Heads figure beside it, never an estimate. ⚠ <strong>Until 25 Sep 2026 this was three columns</strong> — a total plus two quarter buckets. Jerin removed the buckets, so the figure is shown once.'],
          ['Drop', 'Someone who reached <em>Ref Check</em>, <em>Documentation</em> or <em>Offer</em> and was then <strong>archived</strong> \u2014 declined, withdrew, or closed with the offer still open. Counted on the day they first got there, <strong>once</strong> per person, when that day is between the <strong>From</strong> and <strong>To</strong> dates. The small print is Drop \u00f7 (Joined + JP + Drop). \u2014 <strong>drops carry no Score</strong>, only heads: a drop can never be tied to a particular opening in Ashby, and a role is now scored from its opening. Nothing to fix; it is simply not knowable.'],
          ['Delta', 'Goal minus what was achieved — so a positive number is how much is still to do. <strong>It now goes below zero</strong>: a recruiter who has delivered more than their Goal reads as a <strong>minus</strong> number, the surplus, instead of a flat 0. That is how Delta already worked on the <strong>Hiring Manager</strong> and <strong>Overall Efficiency</strong> tabs. It also means a recruiter’s job rows <strong>add up to their own row</strong>, which they did not while the number stopped at zero. What counts as achieved is each table’s own rule: <strong>Joined</strong> on Sales and Others, <strong>Joined + Joining pending</strong> on SME-US and SME-India, and <strong>Joined + Joining pending + Drop</strong> on Lateral. On the Score side the bar fills with the shortfall and stays empty once there is none. The <strong>+N sourced</strong> line underneath is the same sum for what the person sourced: the openings they are tagged on as Sourcer, minus the sourced people counted as achieved.'],
          ['What the brackets in the headings mean <span class="defs-tag">Capacity (Joiners) · Goal (Offers) · Capacity (NA)</span>', 'Each table says in its own headings what it is measured on, because the five pods are not judged the same way. <strong>(Joiners)</strong> — Sales, SME-US, SME-India and Others — means the Goal is measured against people arriving. <strong>(Offers)</strong> — Lateral — means it is measured against <strong>everyone who received an offer</strong>: those who started, those still going through the final steps, and those who dropped out. That is why Lateral is the one table whose Delta subtracts <strong>Drop</strong> too — the offer was made and the work was done, whatever the candidate then decided. <strong>(NA)</strong> on Others means agencies are not given a capacity, so that column is a dash. ⚠ Two places where the word is looser than it looks, kept because they are the plainest words available: on <strong>SME-US</strong> and <strong>SME-India</strong>, <em>(Joiners)</em> also counts people still going through the final steps, not only those who have started; and <strong>Others</strong> reads <em>Capacity (NA)</em> beside <em>Goal (Joiners)</em>, which is right — there is no capacity, but there is a Goal.'],
          ['Capacity used <span class="defs-tag">the column header; also called Capacity Utilisation</span>', 'Achieved ÷ Capacity, both as Score; a dash when no capacity is set, and while the <strong>Job</strong> filter or a department restriction narrows the numbers — part of someone’s work set against all of their capacity would read falsely low. <strong>The colour runs the opposite way to Delta on purpose</strong>: over 100% is over-delivery and reads well, under 70% is under-use and is the thing worth acting on.'],
        ]
      },
      {
        heading: 'Specialisation \u2014 SME - US and SME - India only',
        items: [
          ['Why only these two', 'In these two departments one role can run several different topics at once, with a separate position opened for each. Everywhere else a role is one thing, so a job row simply does not open any further \u2014 no arrow, nothing to click.'],
          ['What the level shows', 'Open a pod, then a recruiter, then an SME job under them, and the job splits by the <strong>Specialization/Topic</strong> recorded against each position in Ashby. A job opens when <strong>at least one of the positions that recruiter owns on it</strong> carries a topic, or when they have <strong>somebody in Reference Check, Documentation or Offer</strong> against a position that does, or <strong>somebody who has already joined</strong> against one \u2014 so a colleague\u2019s position alone does not open the job for them, but their own candidate does.'],
          ['(topic not set)', 'The positions that recruiter owns on the job that nobody has given a topic yet. It is <strong>not</strong> an error, and it is kept so the topics still add up to the job row above. The size of that row is simply how much is left to fill in.'],
          ['Goal on a topic row', 'The <strong>openings that recruiter owns</strong> in that topic, each at its own share and its own points \u2014 the same sum the job row makes, cut by topic. The topics always <strong>add up to the job row</strong> above them. A row that reads <strong>0</strong>, captioned <em>no openings of theirs</em>, is a topic where they own no position but have somebody going through the final steps against one \u2014 it is there for that person, and adds nothing to the Goal.'],
          ['Joining pending on a topic row', 'That recruiter\u2019s people in <strong>Reference Check, Documentation or Offer</strong> whose <strong>offer names a position of this topic</strong> \u2014 heads and score, split half and half with a Sourcer and carrying the same <strong>+N sourced</strong> line as everywhere else on this table. A topic is listed whether or not that recruiter owns a position in it, so <strong>nobody disappears at this level</strong>: the only people left on the job row alone are those whose offer names <strong>no position at all</strong> yet. Add the topics up and you get everyone under this job whose offer names one \u2014 which is why the topics can come to <strong>less</strong> than the job row above, and never to more. The people themselves are listed by name, under their topic, on the <strong>Hiring Manager</strong> tab.'],
          ['Joined on a topic row', 'That recruiter\u2019s joiners whose <strong>offer names a position of this topic</strong> \u2014 heads and score, split half and half with a Sourcer and carrying the same <strong>+N sourced</strong> line as everywhere else. A topic is listed whether or not that recruiter owns a position in it, so a joiner is placed wherever their offer points. Only a joiner whose offer names <strong>no position at all</strong> falls to the <strong>(not tied to a topic)</strong> line underneath — usually there is nobody there, and when there is, it is a missing link on the offer rather than a missing topic, so the topics plus that line always <strong>add up to the job row</strong> above. That line carries Joined only: it has no Goal to be measured against.'],
          ['Why the other columns show a dash', '<strong>Capacity</strong> and <strong>Capacity used</strong> are set per recruiter for the whole quarter and cannot be cut by topic at all. <strong>Drop</strong> keeps its dash because a person who dropped can <em>never</em> be tied to a position \u2014 four ways of recovering it were tested and every one came back empty \u2014 and <strong>Delta</strong> keeps its dash because it is a shortfall against a Goal, which the (not tied to a topic) line does not have. A dash is shown rather than a number that would look right and be wrong. Both figures are correct on the job row above.'],
        ]
      },
      {
      ...
      },
      {
        heading: 'The chart',
        items: [
          ['Chart', '<strong>Each table has its own chart</strong>, directly under its own heading, showing only that pod’s recruiters. One bar per recruiter \u2014 the bar is what they <strong>achieved</strong>. A solid line marks their <strong>Goal</strong>, a dashed line their <strong>Capacity</strong> (not drawn while the Job filter or a department restriction narrows the numbers), and a pale band labelled <em>Short of Goal</em> fills any shortfall. Everything is in Score. Same figures as the table. Each section is split into the <strong>roles</strong> behind it &mdash; hover one to list them. <em>Short of Goal</em> is not split \u2014 it belongs to no single role. The bar is always exactly the table\u2019s Achieved: any credit that no role row under the recruiter carries shows as its own band, <em>credit not tied to a listed role</em>. Hovering a bar shows the Goal.'],
        ]
      },
    ],
    warnings: [
      ['Position Fulfilment — Others', 'The table for the <strong>Others</strong> pod — agencies, freelancers and anyone working across pods rather than inside one. It counts the <strong>same way as Sales</strong>: only people who have <strong>started</strong>, whichever quarter raised the opening. That is the point of it — <strong>agencies bill per joiner</strong>. An internal recruiter turning up here is a mis-mapped candidate or opening for the team to put right, not a reason to soften the rule. Each recruiter sits in exactly one pod, so nobody appears on more than one table and no total or chart double-counts.'],
      ['Only the tables you have filtered to are shown', 'Filter to one <strong>Pod</strong>, or to one <strong>Recruiter</strong>, and the other tables come off the page altogether — heading, chart and all. A pod still in view whose people have nothing this quarter keeps its table, with <em>No recruiters in this group.</em> inside it: that is a pod that delivered nothing, which is worth seeing, not a pod you filtered away.'],
  ...
  'rec-joiningpending': {
    ...
    groups: [
      {
        ...
        items: [
          ['Opening', 'The <strong>position</strong> this person is tied to, by its full name \u2014 <em>IK-403 - Recruiter - Role Type - Topic</em> \u2014 which is what it is called in Ashby. When it cannot be shown the cell says <em>no opening on the offer</em> (nobody has tied the offer to a position yet, so this person cannot be counted against one) or <em>not in this period</em>. While the name is still working its way through the data it shows the position\u2019s short id instead, and turns into the name at the next refresh (Jerin, 23 Sep 2026).'],
          ['Topic', 'On an <strong>SME</strong> role that uses topics, the <strong>Specialization/Topic</strong> of the opening this person\u2019s offer names \u2014 what they were really hired for. When it cannot be shown the cell says <em>why</em>, because each reason is a different job for a different person: <em>no opening on the offer</em> (link the offer to an opening), <em>opening has no topic</em> (set it \u2014 those openings are listed on <strong>Data Hygiene \u2794 Openings Missing a Topic</strong>), or <em>opening not in this period</em>. A role where <strong>no</strong> opening carries a topic shows a plain dash: that role does not use topics, so nothing is missing (Jerin, 23 Sep 2026).'],
          ...
          ['Month and DOJ', 'The joining date, and its month. The date turns <strong>rose</strong> once it has passed and they are still not moved to Hired; hover it for how many days ago. <em>Not set</em> when there is no DOJ yet.'],
    ...
    warnings: [
      ['Longer than Joining pending on Position Fulfilment', 'Those tables count a person only against a recruiter with a row there, and Non-Sales also leaves out anyone on an earlier quarter’s opening or joining next quarter. This list shows everyone.'],
    ]
  },
    ...
    groups: [
      {
        ...
        items: [
          ...
          ['Month and DOJ', 'The day they started, and its month. Hover the date for its weekday.'],
  ...
  'rec-hygiene': {
    ...
    intro: 'The compliance view: candidates, recruiters and roles the pipeline could not attribute cleanly. Pick a list on the left &mdash; its dot and count say whether it <strong>needs a fix</strong>, is <strong>for the record</strong> or has <strong>nothing to fix</strong>. Every list that names a job also shows that job&rsquo;s own <strong>Job status</strong> &mdash; Open, Closed or Archived, straight from Ashby &mdash; so a row sitting against a job nobody is recruiting for any more is easy to skip; closed and archived ones are greyed. <strong>The Job status buttons above the table filter on it</strong>, and they change the rows, this list&rsquo;s count and what the CSV exports together; while a filter is on, the count says how many of the total you are seeing and the side list says so too. A row whose job cannot be identified is shown only under <em>All</em>. Each is fixed <strong>in Ashby</strong> or in <strong>Admin → Pod &amp; Capacity</strong>, and its rows clear at the next refresh; every list downloads as CSV. The Pod, Recruiter, Job, From and To filters never apply here — that is deliberate — so they are hidden on this sub-tab. Someone whose access is limited to certain departments sees only those departments’ rows, and <em>Other Anomalies</em> leaves out unrecognised stage names for them, since a stage name carries no job. <strong>Unassigned, Multiple Recruiters, Multiple Sourcers and both opening-link lists start on 1 July 2026 and do not move with the Year/Quarter selector</strong>, so a Q3 miss stays visible after Q3 ends. Unassigned also lists everyone in Joining Pending with no Recruiter tagged, whatever their dates. The selector does apply to Selected Candidates Missing Source, Pod Not Set, Capacity Not Set, Roles Missing Score Inputs, Jobs Recruiting Without an Opening, and Recruiter Dates (the selected year, from Q3 2026).',
    confirmed: 'Definitions confirmed with Jerin · 24 Aug 2026 · Selected Candidates Missing Source 13 Sep 2026 · lists, 1 July 2026 start and side-list layout 14 Sep 2026 \u00b7 Jobs Recruiting Without an Opening (#125) 15 Sep 2026 \u00b7 the Job status column and its filter (#146, #146b) 19 Sep 2026 · its idle filters hidden (#141b) 17 Sep 2026',
    groups: [
      {
        heading: 'The lists',
        items: [
          ...
          ['Roles Missing Score Inputs', 'Roles that score zero for the selected quarter — usually Tech/NonTech roles missing a Level. SME roles score on Complexity alone and PA by title, so a blank Level does not flag them. <strong>Complexity is read from the opening, and an opening with none scores nothing</strong> \u2014 it no longer counts as Normal. They add headcount but no Score anywhere on the dashboard. Set the Level on the job in Ashby.'],
  ...
  'eff-fulfilment': {
    ...
    confirmed: 'Definitions confirmed with Jerin · 25 Aug 2026 · Joined = someone moved to Hired into the position 14 Sep 2026 \u00b7 Quarter on All adds up the whole year 15 Sep 2026 \u00b7 From / To narrows it to the day (#129) 15 Sep 2026 \u00b7 Specialisation level for SME (#157) 20 Sep 2026 \u00b7 the level stops at the topic (#157c) 21 Sep 2026 \u00b7 a role opens only when one of its positions has a topic; Expand all reaches the topics (#160) 22 Sep 2026 \u00b7 Joining Pending at the topic level, untied people on the role row (#161, A) 22 Sep 2026 · a N no score caption under the Joining Pending total Score (#176c) 25 Sep 2026',
    groups: [
      {
        heading: 'The columns',
        items: [
          ...
          ['Joining Pending', 'Everyone parked in <em>Ref Check</em>, <em>Documentation</em> or <em>Offer</em>, minus anyone whose opening was raised <strong>before the selected period starts</strong>. Counts <strong>people</strong>. Live: it shows who is in closing today, and the period you pick only decides which openings count as earlier. With Quarter on <em>All</em> that is the start of the period, as on the Hiring Manager card Under the Score, a <strong>N no score</strong> caption counts how many of those same people scored <strong>nothing</strong> — their offer names <strong>no opening</strong>, or the opening it names has <strong>no Complexity</strong>. It is a count of the people already in the Heads figure beside it, never an estimate, and it is shown on the <strong>total only</strong>, not on the sub-columns. ⚠ <strong>This tab counts more of them than the Recruiter tab does</strong> — 19 against 4 on 25 Sep 2026 — and both are right: here the rows are <strong>jobs</strong>, so people with <strong>no recruiter named</strong> are still counted, while the Recruiter tab can only show someone on a recruiter’s row. The caption is not shown on the topic rows, where the points come from the job rather than the person’s own opening.'],
          ['Drop', 'Someone who reached <em>Ref Check</em>, <em>Documentation</em> or <em>Offer</em> and was then <strong>archived</strong> \u2014 declined, withdrew, or closed with the offer still open. Counted on the day they first got there, <strong>once</strong> per person, when that day is between the <strong>From</strong> and <strong>To</strong> dates. The small print is Drop \u00f7 (Joined + Joining Pending + Drop). \u2014 <strong>drops carry no Score</strong>, only heads: a drop can never be tied to a particular opening in Ashby, and a role is now scored from its opening. Nothing to fix; it is simply not knowable.'],
          ['Delta', 'Total Positions − Joined − Joining Pending. <strong>It can be negative, and that is allowed</strong> — it means more people are in closing than there are positions recorded, which happens when an offer was never linked to an opening. The bar fills with the shortfall, and a negative Delta shows as a rose minus number.'],
      ...
      },
      {
        ...
        items: [
          ...
          ['Which columns split by topic', '<strong>Total Positions</strong>, <strong>Joined</strong> and <strong>Missed</strong> split for everyone, in HC and in Score, because those count positions and a position carries its own topic. <strong>Joining Pending</strong> splits for the people whose <strong>offer names an opening</strong> of that topic, so the topics can add up to less than the job row above and never to more \u2014 the rest stay on the job row. <strong>Drop</strong> and <strong>Delta</strong> show a dash: a person who dropped can never be tied to a position, and a Delta built on part of the people would mislead. Those two are correct on the job row above.'],
        ]
      },
      {
        heading: 'The chart',
  ...
  'eff-joiningpending': {
    ...
    confirmed: 'Definitions confirmed with Jerin · 25 Aug 2026 · on its own sub-tab (#130) 15 Sep 2026 · the opening Ashby shows them tied to (#132) 15 Sep 2026 · DOJ boxes replace the period boxes (#133) 15 Sep 2026 · badges and date labels (#137) 15 Sep 2026 · month ➔ date ➔ people, option A (#149) 19 Sep 2026 \u00b7 the topic each person was really for, with the reason when it cannot be shown (#168) 23 Sep 2026 \u00b7 Opening and Topic as two columns, the opening by its full name (#169) 23 Sep 2026',
    groups: [
      {
        heading: 'The columns',
        items: [
          ['Linked', 'The chip that says whether this person is tied to a position at all. It used to be headed <em>Opening</em>, which now names the position itself \u2014 two columns with one name helped nobody (#169).'],
          ['Opening', 'The <strong>position</strong> this person is tied to, by its full name \u2014 <em>IK-403 - Recruiter - Role Type - Topic</em> \u2014 which is what it is called in Ashby. When it cannot be shown the cell says <em>no opening on the offer</em> (nobody has tied the offer to a position yet, so this person cannot be counted against one) or <em>not in this period</em>. While the name is still working its way through the data it shows the position\u2019s short id instead, and turns into the name at the next refresh (Jerin, 23 Sep 2026).'],
          ['Topic', 'On an <strong>SME</strong> role that uses topics, the <strong>Specialization/Topic</strong> of the opening this person\u2019s offer names \u2014 what they were really hired for. When it cannot be shown the cell says <em>why</em>, because each reason is a different job for a different person: <em>no opening on the offer</em> (link the offer to an opening), <em>opening has no topic</em> (set it \u2014 those openings are listed on <strong>Recruiter Efficiency \u2794 Data Hygiene \u2794 Openings Missing a Topic</strong>), or <em>opening not in this period</em>. A role where <strong>no</strong> opening carries a topic shows a plain dash: that role does not use topics, so nothing is missing (Jerin, 23 Sep 2026).'],
          ['Joining date / person', 'The list is a tree (#149): <strong>joining month</strong>, then <strong>joining date</strong>, then the people under it — each group heading carrying its own count, so the month and the date come off the person rows entirely. The month heading stays at the top of the table while its dates scroll past. A month wholly in the past is tagged <em>Overdue</em> where it sits. Anyone with no date is kept in a final <strong>Date not set</strong> group — never dropped, so the names always add up to the number beside them.'],
          
          ['What the date headings say', 'The joining date. The heading turns <strong>rose</strong> once the date has passed and they are still not moved to Hired; hover it for the weekday and how many days ago. <em>Not set</em> when there is no DOJ yet.'],
    ...
    groups: [
      {
        ...
        items: [
          ...
          ['What the date headings say', 'The day they started. Hover a date for its weekday.'],
          ['The person', 'The person.'],
          ['Department and Job', 'The role they joined.'],
          ['Recruiter', 'The Recruiter on their hiring team in Ashby, with their initials in their pod’s colour. <em>No recruiter</em> means none is tagged in Ashby.'],
    ...
    groups: [
      {
        heading: 'Reading it',
        items: [
          ['A role\u2019s Score', '<strong>Family + Level + Complexity</strong> \u2192 the grid \u2192 points. Level comes from the job in Ashby and <strong>Complexity from the opening</strong>; Family is derived from the department and job title.'],
