...
export const DEFINITIONS = {
  ...
  'rec-hygiene': {
    ...
    intro: 'The compliance view: candidates, recruiters and roles the pipeline could not attribute cleanly. Pick a list on the left &mdash; its dot and count say whether it <strong>needs a fix</strong>, is <strong>for the record</strong> or has <strong>nothing to fix</strong>. Every list that names a job also shows that job&rsquo;s own <strong>Job status</strong> &mdash; Open, Closed or Archived, straight from Ashby &mdash; so a row sitting against a job nobody is recruiting for any more is easy to skip; closed and archived ones are greyed. Each is fixed <strong>in Ashby</strong> or in <strong>Admin → Pod &amp; Capacity</strong>, and its rows clear at the next refresh; every list downloads as CSV. The Pod, Recruiter, Job, From and To filters never apply here — that is deliberate — so they are hidden on this sub-tab. Someone whose access is limited to certain departments sees only those departments’ rows, and <em>Other Anomalies</em> leaves out unrecognised stage names for them, since a stage name carries no job. <strong>Unassigned, Multiple Recruiters, Multiple Sourcers and both opening-link lists start on 1 July 2026 and do not move with the Year/Quarter selector</strong>, so a Q3 miss stays visible after Q3 ends. Unassigned also lists everyone in Joining Pending with no Recruiter tagged, whatever their dates. The selector does apply to Selected Candidates Missing Source, Pod Not Set, Capacity Not Set, Roles Missing Score Inputs, Jobs Recruiting Without an Opening, and Recruiter Dates (the selected year, from Q3 2026).',
    confirmed: 'Definitions confirmed with Jerin · 24 Aug 2026 · Selected Candidates Missing Source 13 Sep 2026 · lists, 1 July 2026 start and side-list layout 14 Sep 2026 \u00b7 Jobs Recruiting Without an Opening (#125) 15 Sep 2026 \u00b7 the Job status column (#146) 19 Sep 2026 · its idle filters hidden (#141b) 17 Sep 2026',
    groups: [
      {
        heading: 'The lists',
        items: [
