    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          ['Joined on a topic row', 'That recruiter\u2019s joiners whose <strong>offer names a position of this topic</strong> \u2014 heads and score, split half and half with a Sourcer and carrying the same <strong>+N sourced</strong> line as everywhere else. A joiner whose offer names <strong>no position</strong>, or one on a topic this recruiter owns nothing in, sits on the <strong>(not tied to a topic)</strong> line underneath, so the topics plus that line always <strong>add up to the job row</strong> above. That line carries Joined only: it has no Goal to be measured against.'],
