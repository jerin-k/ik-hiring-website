    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          ['Why the other columns show a dash', '<strong>Capacity</strong> and <strong>Capacity used</strong> are set per recruiter for the whole quarter and cannot be cut by topic at all. <strong>Joined</strong>, <strong>Drop</strong> and <strong>Delta</strong> count <em>people</em>: Ashby ties someone to a specific position only when they are hired, and a person who dropped can never be tied to one \u2014 so there is no honest per-topic figure and a dash is shown rather than a number that would look right and be wrong. Those figures are correct on the job row above.'],
        ]
      },
      {
