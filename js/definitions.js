...
export const DEFINITIONS = {
  ...
  'rec-fulfilment': {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          ['Delta', 'Goal minus what was achieved, so it is the shortfall. The bar fills with that shortfall, so the bar and the number always agree. Never shown below zero. The <strong>+N sourced</strong> line underneath is the same sum for what the person sourced: the openings they are tagged on as Sourcer, minus the sourced people counted as achieved — also never below zero.'],
      ...
      },
      {
        ...
        items: [
          ...
          ['Agency, freelancer or internal makes no difference', 'Everyone follows the same rule, as recruiter or as sourcer. The <strong>Agency</strong> / <strong>Freelancer</strong> / <strong>Internal</strong> setting in <strong>Admin → Metric Configuration</strong> is kept as a label only. <em>Changed 13 Sep 2026: an agency sourcing an SME role used to take the whole score.</em>'],
    ...
    warnings: [
      ...
      ['Drop includes people who never had an offer raised', 'Until 26 Aug it did not — Drop required an offer record, which silently excluded anyone archived out of Ref Check or Documentation before anyone raised one. Every archived application was checked: <strong>17 such people</strong> were invisible, and 2026-Q2 went from 20 drops to 30.'],
      ['Recruiters who weren\u2019t here this quarter are hidden by default', 'A recruiter counts from their <strong>Started on</strong> date to their <strong>Left on</strong> date, set in <strong>Admin \u2192 Metric Configuration</strong> \u2014 someone who left mid-quarter still counts for that quarter. Until a recruiter\u2019s dates are entered, a disabled Ashby account decides, as before. Their history still counts either way; tick <em>Not here this quarter</em> to see them.'],
    ...
    groups: [
      {
        ...
        items: [
          ...
          ['Who each person is counted against', 'Every number in this table is a <strong>count of people</strong>, and each person counts <strong>whole</strong> against their <strong>recruiter</strong> — the same as the HC columns in Fulfilment, whoever sourced the role. <em>Changed 13 Sep 2026: an agency that sourced the role used to take the person.</em>'],
    ...
    groups: [
      {
        heading: 'The columns',
        items: [
          ['Assessed / Added', 'Candidates <strong>assessed</strong> at the stage during the period — an interview actually held there, an assignment triggered there, or a feedback form (a select or reject) where no interview exists. Someone who only sat in the queue does not count. \u26a0 <strong>Ref Check, Documentation and Offer are counted differently</strong>: nobody is interviewed or assessed at an administrative stage, so those three count the candidates <strong>added</strong> to the stage \u2014 the day they entered it. Progressed means the same thing throughout; for Offer it means they went on to be <strong>hired</strong>.'],
    ...
    groups: [
      {
        ...
        items: [
          ...
          ['In quarter', 'Whether they count in the quarter chosen at the top, and why. With both dates blank, the Ashby account decides, exactly as before these dates existed.'],
          ['Ashby account', '<strong>Read from the Ashby seat, not editable here.</strong> Enabled means the person holds an elevated recruiter seat. It only decides who counts for people with no dates set; their past offers and hires still score either way.'],
