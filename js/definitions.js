...
export const DEFINITIONS = {
  ...
  'hm-joiners': {
    ...
    confirmed: 'Added with Jerin · 15 Sep 2026 (#130) · the opening read from the hire (#131) 15 Sep 2026 · badges and date labels (#137) 15 Sep 2026 · month ➔ date ➔ people, option A (#149) 19 Sep 2026 \u00b7 the topic each person was really for, with the reason when it cannot be shown (#168) 23 Sep 2026',
    groups: [
      {
        heading: 'The columns',
        items: [
