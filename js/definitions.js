    ...
    groups: [
      {
        ...
        items: [
          ...
          ['HC and Score', '<strong>HC</strong> is the count. <strong>Score</strong> is the <strong>total of that job\u2019s openings\u2019 scores</strong> - what its open positions are worth together - each read from its OWN Complexity (Family + Level + Complexity, from <strong>Admin → Scoring</strong>). A role that scores zero — usually a Tech/NonTech role with no Level; SME roles score on Complexity alone and Program Advisor roles by title — is marked <em>unscored</em>: it still counts in HC but adds nothing to Score. It is the same test as Recruiter Efficiency → Data Hygiene → Roles Missing Score Inputs.'],
        ]
      },
      {
        heading: 'Specialisation \u2014 SME - US and SME - India only',
