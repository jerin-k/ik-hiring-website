  ...
  'rec-fulfilment': {
    ...
    groups: [
      ...
      },
      {
        heading: 'The columns',
        items: [
          ['Goal — Joiners', 'The <strong>openings you own</strong> in the selected quarter — the positions where you are the <strong>Recruiter on the opening</strong> in Ashby, not every role you have ever touched. Each opening scores from its role’s Family, Level and Complexity. Where an opening also has a <strong>Sourcer</strong>, its points are shared with them on the same rule the outcome side uses, so a Goal can show a half. The sharing is worked out <strong>one opening at a time</strong>: if a sourcer worked some of a role’s openings but not all of them, only those openings are shared and the rest stay wholly with the recruiter.'],
      ...
      },
      {
        ...
        items: [
          ...
          ['SME - India and SME - US', 'An <strong>agency</strong> sourcer takes the <strong>whole score</strong> and the recruiter gets nothing — on these roles the sourcing is the job. <strong>Everyone else splits it half and half</strong>, whether they are a freelancer or one of our own recruiters helping out. <em>Changed 10 Sep 2026: an internal sourcer used to earn nothing here and the recruiter kept the lot.</em>'],
          ...
          ['Who counts as an agency', 'It is set by hand in <strong>Admin → Metric Configuration</strong> — every recruiter can be marked <strong>Agency</strong>, <strong>Freelancer</strong> or <strong>Internal</strong>. Ashby’s <em>External Recruiter</em> flag only decides the <strong>starting value</strong>, because it is not a reliable signal on its own: it catches duplicate accounts of our own people, and it misses genuine externals who hold a normal seat. Anything not yet reviewed starts as a <strong>Freelancer</strong> if Ashby flags it external, otherwise <strong>Internal</strong>. <em>Widened 10 Sep 2026: the choice used to be locked for everyone Ashby did not flag.</em>'],
