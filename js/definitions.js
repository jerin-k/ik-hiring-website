    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          ['Chart', 'One bar per <strong>day</strong>, stacked by <strong>recruiter</strong> \u2014 one colour each, so a day reads as who added people that day. Inside a recruiter\u2019s block the <strong>roles</strong> are divided by a line one shade darker. Hover any block for the recruiter, the role and the count. The legend is per recruiter; clicking one hides all of their roles at once. Past twelve recruiters the rest pool into one grey block, because more colours than that stop being tellable apart.'],
    ...
    groups: [
      {
        ...
        items: [
          ...
          ['Chart', 'One bar per recruiter: the solid part progressed past R1, the pale part is still sitting at R1, and the two together are how many were added. The number at the end of each bar is the total added, and the percentage sits in its own labelled column at the right. Each coloured section is divided into the <strong>roles</strong> behind it by a thin line one shade darker than the bar. Very small roles are pooled into the last division so the lines stay readable — nobody is dropped, and the totals do not change. Hover a division for the role name. The number stays on the section as a whole, not on every division.'],
        ]
      },
    ],
    warnings: [
    ...
    groups: [
      {
        ...
        items: [
          ...
          ['Chart', 'One bar per department: the solid part progressed past R1, the pale part is still at R1, and together they are how many were added. Each coloured section is divided into the <strong>roles</strong> behind it by a thin line one shade darker than the bar. Very small roles are pooled into the last division so the lines stay readable — nobody is dropped, and the totals do not change. Hover a division for the role name. The number stays on the section as a whole, not on every division.'],
        ]
      },
    ],
    warnings: [
